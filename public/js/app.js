...
var initProduct = function initProduct() {
  ...
  var initProductColors = function initProductColors() {
    var productColors = document.querySelectorAll(".group\\/color");
    console.log("productColros", productColors);
    var fetchProductGallery = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(color) {
        var response;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("".concat(_src_js_API_js__WEBPACK_IMPORTED_MODULE_2__.endpoint, "/product"));
            case 2:
      ...
      return function fetchProductGallery(_x) {
        return _ref.apply(this, arguments);
      };
    }();
    productColors.forEach(function (productControl) {
      productControl.addEventListener("click", function () {
        var color = productControl.getAttribute("data-color");
        if (color) {
          fetchProductGallery();
        }
      });
