...
/* harmony import */ var _src_js_dropdown_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../src/js/dropdown.js */ "./src/js/dropdown.js");
/* harmony import */ var _src_js_header_nav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../src/js/header-nav */ "./src/js/header-nav.js");
/* harmony import */ var _src_js_search__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../src/js/search */ "./src/js/search.js");
/* harmony import */ var _src_js_megamenu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../src/js/megamenu */ "./src/js/megamenu.js");
/* harmony import */ var _src_js_filter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../src/js/filter */ "./src/js/filter.js");
/* harmony import */ var _src_js_swiper_hero__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../src/js/swiper-hero */ "./src/js/swiper-hero.js");
/* harmony import */ var _src_js_swiper_promo__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../src/js/swiper-promo */ "./src/js/swiper-promo.js");
/* harmony import */ var _src_js_swiper_loyalty__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../../src/js/swiper-loyalty */ "./src/js/swiper-loyalty.js");
/* harmony import */ var _src_js_card_product__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../../src/js/card-product */ "./src/js/card-product.js");
/* harmony import */ var _src_js_product_product_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../src/js/product/product.js */ "./src/js/product/product.js");
...
(0,_src_js_dropdown_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_src_js_header_nav__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_src_js_search__WEBPACK_IMPORTED_MODULE_6__["default"])();
(0,_src_js_megamenu__WEBPACK_IMPORTED_MODULE_7__["default"])();
(0,_src_js_filter__WEBPACK_IMPORTED_MODULE_8__["default"])();
(0,_src_js_swiper_hero__WEBPACK_IMPORTED_MODULE_9__["default"])();
(0,_src_js_swiper_promo__WEBPACK_IMPORTED_MODULE_10__["default"])();
(0,_src_js_swiper_loyalty__WEBPACK_IMPORTED_MODULE_11__["default"])();
(0,_src_js_card_product__WEBPACK_IMPORTED_MODULE_12__["default"])();
(0,_src_js_product_product_js__WEBPACK_IMPORTED_MODULE_13__["default"])();
...
var initAria = function initAria() {
  ...
  document.addEventListener("click", function (event) {
    ...
    var target = event.target;
    var toggle = target.closest("[aria-expanded]:not([data-bs-toggle])");
    if (toggle) {
...
var initDropdown = function initDropdown() {
  ...
  var dropdownList = _toConsumableArray(toggles).map(function (dropdownToggleEl) {
    return new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Dropdown(dropdownToggleEl);
  });
...
var initFilter = function initFilter() {
  var filterContainer = document.querySelector("#filter-wrapper");
  var filterCollapseToggle = document.querySelector(".filter-collapse-toggle");
  var filterSecondaryParams = filterContainer === null || filterContainer === void 0 ? void 0 : filterContainer.querySelectorAll('[aria-expanded="false"]');
  var handleFilterClose = function handleFilterClose() {
  ...
  var handleFilterToggleParams = function handleFilterToggleParams() {
    var handleExpandParams = function handleExpandParams() {
      filterSecondaryParams.forEach(function (item) {
        item.setAttribute("aria-expanded", true);
        item.setAttribute("aria-hidden", false);
      });
    };
    var handleCollapseParams = function handleCollapseParams() {
      filterSecondaryParams.forEach(function (item) {
    ...
    if (filterSecondaryParams.length) {
      var isExpanded = filterSecondaryParams[0].getAttribute("aria-expanded");
...
/* harmony import */ var _src_js_API_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../src/js/API.js */ "./src/js/API.js");



var initProduct = function initProduct() {
  var initProductGallery = function initProductGallery() {
  ...
  var initProductColors = function initProductColors() {
  ...
  var initProductBuyPopup = function initProductBuyPopup() {
    var productBuyCotainer = document.querySelector(".product-buy");
    var productBuyToggle = document.querySelector(".product-buy__toggle");
    var productPartners = document.querySelector("#product-partners");
    if (productBuyCotainer && productBuyToggle && productPartners) {
      productBuyCotainer.addEventListener("mouseleave", function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initHeroSlider);

/***/ }),

/***/ "./src/js/swiper-loyalty.js":
/*!**********************************!*\
  !*** ./src/js/swiper-loyalty.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initLoyaltySlider = function initLoyaltySlider() {
  var loyaltyContainer = document.querySelector(".section-loyalty");
  var loyaltySliderContainer = document.querySelector(".swiper-loyalty");
  var loyaltyDate = document.querySelector("#loyalty-date-select");
  if (loyaltyContainer && loyaltySliderContainer) {
    ...
    loyaltyDate.addEventListener("change", function (event) {
      loyaltySwiper.slideTo(event.target.value);
    });
    loyaltySwiper.slides.forEach(function (slide) {
      var loyaltyMonths = slide.querySelector(".swiper-loyalty-months");
      var loyaltyPanels = slide.querySelector(".swiper-loyalty-panels");
      if (loyaltyMonths && loyaltyPanels) {
        var monthsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](loyaltyMonths, {
          modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation],
          slidesPerView: 2,
          slidesPerGroup: 2,
          spaceBetween: 16,
        ...
        new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](loyaltyPanels, {
          modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade],
          slidesPerView: 1,
          rewind: true,
          nested: true,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initLoyaltySlider);

/***/ }),

/***/ "./src/js/swiper-promo.js":
/*!********************************!*\
  !*** ./src/js/swiper-promo.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var initPromoSlider = function initPromoSlider() {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-promo", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initPromoSlider);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmaxvi_v2"] = self["webpackChunkmaxvi_v2"] || [];
